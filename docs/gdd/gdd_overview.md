# Universe Unlimited — GDD (обзор)
Статус: черновик (v0.1)
Источник: [U2 GDD v0.1.md](../archive/U2 GDD v0.1.md)

Кратко
- MMO с акцентом на полёт/бой, модульные подсистемы, развитый UX.
- Сервер: намётки CQRS/Event Sourcing; клиент: прототипы и UX‑наброски.

План консолидации
- Свести ключевые тезисы в этот файл, вынести подробности в тематические `spec_*.md`.
- Поддерживать оглавление и перекрёстные ссылки.


---

## Приложение A — полный текст источника (v0.1)
