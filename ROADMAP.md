...
- **M3.0** - FA:ON/OFF (Flight Assist) ⚠️ (серверная логика готова, клиентская интеграция завершена)
...
graph LR
    ...
    M2.3 --> M3[M3: FA:ON/OFF<br/>⚠️ 3-4 недели]
...
| **M2.3** | ✅ Завершён | 2-3 нед | 2025-11-18 | 2025-12-09 | - |
| **M3** | ⚠️ В процессе | 3-4 нед | 2025-12-09 | 2026-01-06 | **ВЫСОКИЙ** |
...
- ✅ **217/217 тестов** (100% passing) ← +16 FlightAssist тестов
- 🔜 **FPS 60** @ 1080p (M6)
...
- ⚠️ **FA:ON/OFF**: реализовано (M3, тестирование в процессе)
