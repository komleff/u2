...
Write-Host "Starting C# backend (UDP + WebSocket relay)..." -ForegroundColor Cyan
...
Write-Host "  - C# UDP Backend: localhost:7777" -ForegroundColor Green
Write-Host "  - WebSocket Relay: ws://localhost:8080" -ForegroundColor Green
Write-Host "  - Vite Client: http://localhost:5173" -ForegroundColor Green
